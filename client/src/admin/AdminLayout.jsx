...
export default function AdminLayout() {
  ...
  return (
    <div className="flex h-screen bg-[#F8FAFC]">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-[#0F172A] text-slate-300 transform transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:inset-0 ${
        ...
        <header className="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-6 z-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center bg-slate-100 rounded-full px-4 py-2 text-slate-500 w-80">
              ...
              />
              <span className="text-xs bg-white border rounded px-1.5 py-0.5 shadow-sm">
                ⌘K
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative" ref={userMenuRef}>
              <button
                ...
                className="flex items-center gap-2 hover:bg-slate-50 p-1.5 rounded-full pr-3 transition border border-transparent hover:border-slate-200"
              >
